...
class Swiper():
    def __init__(self):
        self.email = input('Opened Facebook. Please enter username/email: ')
        self.password = getpass(prompt='Username entered. Please enter password: ')
        self.driver = webdriver.Chrome("/home/charlie/chromedriver")
